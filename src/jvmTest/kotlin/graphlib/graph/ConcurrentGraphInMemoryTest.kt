...
internal class ConcurrentGraphInMemoryTest {

        @Test
        fun constructorTest() {
            val graph = SimpleConcurrentDirectedGraph(SimpleVertex("id"))
        ...
        @Test
        fun addVertex() {
            val graph = SimpleConcurrentDirectedGraph()
        ...
        private fun createGraph(): ITypedGraph<SimpleVertex, SimpleDirectedEdge<SimpleVertex>> = SimpleConcurrentDirectedGraph() init {
            // Vertices
            +v1
            +v2
            +v3
